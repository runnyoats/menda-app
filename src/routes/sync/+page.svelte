<script>
	...
	let modalOpen = false;
	setContext('simple-modal', { open: () => (modalOpen = true), close: () => (modalOpen = false) });
...
<div class="flex items-center">
	...
	<Button on:click={() => (modalOpen = true)} size="sm" className="mr-2 hidden md:block"
		>Export / Import to Excel</Button
	>
</div>
